...
c.fonts.default_family = ["Iosevka Comfy Wide"]
...
c.url.searchengines = {
    ...
    "tab": "https://www.songsterr.com/?pattern={}",
    "yt": "https://www.youtube.com/results?search_query={}",
    "def": "https://www.merriam-webster.com/dictionary/{}",
    # "julia": "https://docs.julialang.org/en/v1/search/?1={}",
...
# dracula
from themes.dracula import draw
...
# onedark
config.source('themes/onedark/themes/onedark.py')
...
config.bind("xt", "config-cycle tabs.show never always multiple switching")
config.bind(
    "xx",
...
config.bind(
    " B",
    "spawn --detach brave --enable-features=UseOzonePlatform --ozone-platform=wayland {url}",
)
...
# new tab, would prefer it go to home page?...
...
# eval javascript
# probably not useful but need to figure out how to enter the eval command and wait
config.bind(" j", "jseval {}")
